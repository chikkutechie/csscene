...
#define TESTDEF(testcase, test, parent, status) \
    ...
    bool testcase##_##test##_res = chikkooos::RTestManager::instance()->addTest(new testcase##_##test##_test()); \
    void testcase##_##test##_test::exec()

#define TEST(testcase, test) TESTDEF(testcase, test, chikkooos::RTest, chikkooos::RTest::Passed)
#define TEST_D(testcase, test) TESTDEF(testcase, test, chikkooos::RTest, chikkooos::RTest::Disabled)
#define TEST_F(testcase, test) TESTDEF(testcase, test, testcase, chikkooos::RTest::Passed)
#define TEST_F_D(testcase, test) TESTDEF(testcase, test, testcase, chikkooos::RTest::Disabled)

#define ExcecuteTests() chikkooos::RTestManager::instance()->exec()
